...
title: fhir-observation-definition
order: 24
---

# fhir-observation-definition

| Item | Value |
| ---- | ----- |
| Catalog | [Domain Resources](../) |
| Category | Resource Renderers |
| Class | `ObservationDefinition` |
| Superclass | `DomainResource` |
| Source | [observation-definition/observation-definition.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/observation-definition/observation-definition.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-observation-definition .data=${data}&gt;&lt;/fhir-observation-definition&gt;
</code-example>
...
| `override-template` | `string` |  | `Resource` |  |
