...
| Source | [appointment/appointment.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/appointment/appointment.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-appointment .data=${data}&gt;&lt;/fhir-appointment&gt;
</code-example>
