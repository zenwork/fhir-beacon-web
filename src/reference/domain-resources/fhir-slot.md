...
| Source | [slot/slot.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/slot/slot.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-slot .data=${data}&gt;&lt;/fhir-slot&gt;
</code-example>
