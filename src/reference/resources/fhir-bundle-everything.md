...
title: fhir-bundle-everything
order: 21
---

# fhir-bundle-everything

| Item | Value |
| ---- | ----- |
| Catalog | [Resources](../) |
| Category | Foundation Components |
| Class | `BundleEverything` |
| Superclass | `Bundle` |
| Source | [bundle/bundle-everything.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/foundation/bundle/bundle-everything.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-bundle-everything .data=${data}&gt;&lt;/fhir-bundle-everything&gt;
</code-example>
