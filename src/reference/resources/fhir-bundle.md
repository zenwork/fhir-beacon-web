...
| Source | [bundle/bundle.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/foundation/bundle/bundle.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-bundle .data=${data}&gt;&lt;/fhir-bundle&gt;
</code-example>
