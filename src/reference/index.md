...
Reference is lookup material. It should answer what exists and how to use the
exact thing you need.

## Reference Pages

- [FHIR Reference](./fhir-reference/) covers FHIR resource types, data types,
  terminologies, artifacts, profiles, and extensions.
- [Library Reference](./library-reference/) covers package metadata, component
  catalog, common inputs, exported APIs, compatibility, Storybook, and release
  sources.
...
metadata. FHIR coverage is curated from the library source and FHIR
specification. Library component coverage is generated from package metadata,
custom elements metadata, web-types metadata, Storybook, and the library
changelog.
...
| Custom elements manifest | [`custom-elements.json`](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/build/custom-elements.json) |
...
Regenerate the library lookup page after each fhir-beacon release:
