...
| Source | [period/period.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/complex/period/period.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-period .data=${data}&gt;&lt;/fhir-period&gt;
</code-example>
