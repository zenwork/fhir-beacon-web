...
title: fhir-appointment-recurrence-template
order: 45
---
...
| Category | Resource Backbone Components |
| Class | `AppointmentRecurrenceTemplateBackbone` |
| Superclass | `Backbone` |
| Source | [appointment/appointment-recurrence-template.backbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/appointment/appointment-recurrence-template.backbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-appointment-recurrence-template .data=${data}&gt;&lt;/fhir-appointment-recurrence-template&gt;
</code-example>
