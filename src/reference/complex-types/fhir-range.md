...
| Source | [range/range.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/complex/range/range.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-range .data=${data}&gt;&lt;/fhir-range&gt;
</code-example>
