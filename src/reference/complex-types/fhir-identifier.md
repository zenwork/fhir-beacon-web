...
| Source | [identifier/identifier.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/complex/identifier/identifier.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-identifier .data=${data}&gt;&lt;/fhir-identifier&gt;
</code-example>
