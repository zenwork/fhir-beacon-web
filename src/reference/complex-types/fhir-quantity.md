...
| Source | [quantity/quantity.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/complex/quantity/quantity.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-quantity .data=${data}&gt;&lt;/fhir-quantity&gt;
</code-example>
