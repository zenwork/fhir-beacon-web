...
| Source | [ratio/ratio.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/complex/ratio/ratio.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-ratio .data=${data}&gt;&lt;/fhir-ratio&gt;
</code-example>
