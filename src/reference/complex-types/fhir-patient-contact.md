...
| Class | `PatientContactBackbone` |
| Superclass | `Backbone` |
| Source | [patient/patient-contact.backbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/patient/patient-contact.backbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-patient-contact .data=${data}&gt;&lt;/fhir-patient-contact&gt;
</code-example>
