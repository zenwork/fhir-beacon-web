...
| Source | [attachment/attachment.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/complex/attachment/attachment.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-attachment .data=${data}&gt;&lt;/fhir-attachment&gt;
</code-example>
