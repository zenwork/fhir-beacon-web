...
| Class | `Procedure` |
| Superclass | `Backbone` |
| Source | [backbone/procedure.backbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/account/backbone/procedure.backbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-account-procedure .data=${data}&gt;&lt;/fhir-account-procedure&gt;
</code-example>
