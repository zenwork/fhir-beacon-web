...
title: fhir-yearly-template
order: 57
---

# fhir-yearly-template
...
| Superclass | `Backbone` |
| Source | [appointment/appointment-yearly-template.bacbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/appointment/appointment-yearly-template.bacbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-yearly-template .data=${data}&gt;&lt;/fhir-yearly-template&gt;
</code-example>
