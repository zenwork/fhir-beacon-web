...
| Class | `PatientLink` |
| Superclass | `Backbone` |
| Source | [patient/patient-link.backbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/patient/patient-link.backbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-patient-link .data=${data}&gt;&lt;/fhir-patient-link&gt;
</code-example>
