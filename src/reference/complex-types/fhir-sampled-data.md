...
| Source | [sampled-data/sampled-data.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/complex/sampled-data/sampled-data.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-sampled-data .data=${data}&gt;&lt;/fhir-sampled-data&gt;
</code-example>
