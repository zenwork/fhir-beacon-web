...
| Class | `Guarantor` |
| Superclass | `Backbone` |
| Source | [backbone/guarantor.backbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/account/backbone/guarantor.backbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-account-guarantor .data=${data}&gt;&lt;/fhir-account-guarantor&gt;
</code-example>
