...
| Class | `Coverage` |
| Superclass | `Backbone` |
| Source | [backbone/coverage.backbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/account/backbone/coverage.backbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-account-coverage .data=${data}&gt;&lt;/fhir-account-coverage&gt;
</code-example>
