...
| Category | Special FHIR Components |
| Class | `Extension` |
| Superclass | `BaseElement` |
| Source | [extension/extension.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/special/extension/extension.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-extension .data=${data}&gt;&lt;/fhir-extension&gt;
</code-example>
