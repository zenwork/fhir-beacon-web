...
| Source | [timing/timing.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/complex/timing/timing.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-timing .data=${data}&gt;&lt;/fhir-timing&gt;
</code-example>
