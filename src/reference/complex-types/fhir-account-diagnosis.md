...
| Class | `Diagnosis` |
| Superclass | `Backbone` |
| Source | [backbone/diagnosis.backbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/account/backbone/diagnosis.backbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-account-diagnosis .data=${data}&gt;&lt;/fhir-account-diagnosis&gt;
</code-example>
