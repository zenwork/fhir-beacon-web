...
title: fhir-monthly-template
order: 48
---

# fhir-monthly-template
...
| Superclass | `Backbone` |
| Source | [appointment/appointment-monthly-template.bacbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/appointment/appointment-monthly-template.bacbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-monthly-template .data=${data}&gt;&lt;/fhir-monthly-template&gt;
</code-example>
