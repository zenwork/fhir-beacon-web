...
title: fhir-observation-reference-range
order: 50
---
...
| Superclass | `Backbone` |
| Source | [observation/observation-reference-range.backbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/observation/observation-reference-range.backbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-observation-reference-range .data=${data}&gt;&lt;/fhir-observation-reference-range&gt;
</code-example>
