...
title: fhir-appointment-participant
order: 44
---
...
| Class | `AppointmentParticipantBackbone` |
| Superclass | `Backbone` |
| Source | [appointment/appointment-participant.backbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/appointment/appointment-participant.backbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-appointment-participant .data=${data}&gt;&lt;/fhir-appointment-participant&gt;
</code-example>
