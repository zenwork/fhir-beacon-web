...
| Class | `TimingRepeat` |
| Superclass | `Backbone` |
| Source | [timing/timing-repeat.backbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/complex/timing/timing-repeat.backbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-timing-repeat .data=${data}&gt;&lt;/fhir-timing-repeat&gt;
</code-example>
