...
| Source | [annotation/annotation.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/complex/annotation/annotation.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-annotation .data=${data}&gt;&lt;/fhir-annotation&gt;
</code-example>
