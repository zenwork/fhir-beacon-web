...
title: fhir-account-related-account
order: 43
---
...
| Superclass | `Backbone` |
| Source | [backbone/related-account.backbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/account/backbone/related-account.backbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-account-related-account .data=${data}&gt;&lt;/fhir-account-related-account&gt;
</code-example>
