...
title: fhir-patient-communication
order: 52
---
...
| Class | `PatientCommunicationBackbone` |
| Superclass | `Backbone` |
| Source | [patient/patient-communication.backbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/patient/patient-communication.backbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-patient-communication .data=${data}&gt;&lt;/fhir-patient-communication&gt;
</code-example>
