...
title: fhir-observation-component
order: 49
---
...
| Superclass | `Backbone` |
| Source | [observation/observation-component.backbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/observation/observation-component.backbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-observation-component .data=${data}&gt;&lt;/fhir-observation-component&gt;
</code-example>
