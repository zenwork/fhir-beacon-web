...
| Class | `Balance` |
| Superclass | `Backbone` |
| Source | [backbone/balance.backbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/account/backbone/balance.backbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-account-balance .data=${data}&gt;&lt;/fhir-account-balance&gt;
</code-example>
