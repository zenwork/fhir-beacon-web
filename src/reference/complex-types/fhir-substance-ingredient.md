...
title: fhir-substance-ingredient
order: 55
---
...
| Class | `SubstanceIngredientBackbone` |
| Superclass | `BaseElement` |
| Source | [substance/substance-ingredient.backbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/substance/substance-ingredient.backbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-substance-ingredient .data=${data}&gt;&lt;/fhir-substance-ingredient&gt;
</code-example>
