...
title: fhir-medication-ingredient
order: 47
---
...
| Class | `MedicationIngredientBackbone` |
| Superclass | `Backbone` |
| Source | [medication/medication-ingredient.backbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/medication/medication-ingredient.backbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-medication-ingredient .data=${data}&gt;&lt;/fhir-medication-ingredient&gt;
</code-example>
