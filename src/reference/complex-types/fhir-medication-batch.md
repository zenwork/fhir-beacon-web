...
| Class | `MedicationBatchBackbone` |
| Superclass | `Backbone` |
| Source | [medication/medication-batch.backbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/medication/medication-batch.backbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-medication-batch .data=${data}&gt;&lt;/fhir-medication-batch&gt;
</code-example>
