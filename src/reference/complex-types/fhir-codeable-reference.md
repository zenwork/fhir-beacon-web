...
| Source | [codeable-reference/codeable-reference.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/complex/codeable-reference/codeable-reference.ts) |
