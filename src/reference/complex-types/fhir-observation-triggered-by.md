...
title: fhir-observation-triggered-by
order: 51
---

# fhir-observation-triggered-by
...
| Superclass | `Backbone` |
| Source | [observation/observation-triggered-by.backbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/observation/observation-triggered-by.backbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-observation-triggered-by .data=${data}&gt;&lt;/fhir-observation-triggered-by&gt;
</code-example>
