...
| Source | [contact-point/contact-point.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/complex/contact-point/contact-point.ts) |
