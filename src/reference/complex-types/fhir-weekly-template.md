...
title: fhir-weekly-template
order: 56
---

# fhir-weekly-template
...
| Superclass | `Backbone` |
| Source | [appointment/appointment-weekly-template.bacbone.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/resources/appointment/appointment-weekly-template.bacbone.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-weekly-template .data=${data}&gt;&lt;/fhir-weekly-template&gt;
</code-example>
