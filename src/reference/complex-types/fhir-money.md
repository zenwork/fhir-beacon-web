...
| Source | [money/money.ts](https://github.com/zenwork/fhir-beacon/blob/main/packages/library/src/components/complex/money/money.ts) |
| Storybook | [Open Storybook](https://fhir-beacon.deno.dev) |

## Usage Skeleton

<code-example language="html">
&lt;fhir-money .data=${data}&gt;&lt;/fhir-money&gt;
</code-example>
